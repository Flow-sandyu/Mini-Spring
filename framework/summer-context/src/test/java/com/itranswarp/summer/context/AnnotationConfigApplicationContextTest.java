...
import com.itranswarp.scan.circularde_pendency.AA;
import com.itranswarp.scan.circularde_pendency.BB;
...
public class AnnotationConfigApplicationContextTest {
    ...
    public void testCircularDependency() {
        ...
        // 测试工厂方法的依赖循环
        var ctx = new AnnotationConfigApplicationContext(AA.class, createPropertyResolver());
        assertNotNull(ctx.getBean(AA.class));
        assertNotNull(ctx.getBean(BB.class));
