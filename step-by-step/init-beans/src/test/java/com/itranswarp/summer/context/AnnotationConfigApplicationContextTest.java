...
import com.itranswarp.scan.init.InitScanApplication;
import com.itranswarp.scan.injection.InjectionScanApplication;
import com.itranswarp.scan.injection.SetterInjection;
...
import com.itranswarp.scan.injection.FieldInjection;
...
public class AnnotationConfigApplicationContextTest {
    ...
    public void testInitMethod() {
        var ctx = new AnnotationConfigApplicationContext(InitScanApplication.class, createPropertyResolver());
        // test @PostConstruct:
    ...
    public void testInjection() {
        var ctx = new AnnotationConfigApplicationContext(InjectionScanApplication.class, createPropertyResolver());
        var bean1 = ctx.getBean(FieldInjection.class);
        var bean2 = ctx.getBean(SetterInjection.class);
        assertEquals("Scan App" ,bean2.getAppTitle());
        System.out.println(bean2.getAppTitle());
        System.out.println(bean2.getFieldInjection());
    }
