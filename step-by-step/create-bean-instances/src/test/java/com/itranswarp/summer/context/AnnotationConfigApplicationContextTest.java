...
import com.itranswarp.scan.circularde_pendency.A;
import com.itranswarp.scan.circularde_pendency.B;
import com.itranswarp.scan.test_autowire.AutowireName;
import com.itranswarp.scan.test_autowire.BaoMa;
import com.itranswarp.scan.test_autowire.Car;
...
public class AnnotationConfigApplicationContextTest {
    ...
    @Test
    public void testAutoWireName() {
        var ctx = new AnnotationConfigApplicationContext(ScanApplication.class, createPropertyResolver());
        AutowireName autowireName = (AutowireName) ctx.getBean("autowireName");
        assertEquals(autowireName.getCar1().getClass(), new BaoMa().getClass());
    }
    ...
    public void testCircularDependency() {
        var ctx = new AnnotationConfigApplicationContext(A.class, createPropertyResolver());
        assertNotNull(ctx.getBean(A.class));
        assertNotNull(ctx.getBean(B.class));
    }
