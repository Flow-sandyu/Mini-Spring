...
public class AnnotationConfigApplicationContextTest {
    ...
    public void testProxy() {
        // var ctx = new AnnotationConfigApplicationContext(com.itranswarp.scan.aaa.ScanApplication.class, createPropertyResolver());
        ...
        // make sure proxy.getField is injected:
